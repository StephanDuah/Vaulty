...
export default function UserVerificationForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append("documentType", formDataState.documentType);
      formData.append("documentNumber", formDataState.documentNumber);
      ...
      formData.append("additionalInfo", formDataState.additionalInfo);
      ...
      // Call server action to submit verification
      ...
      if (result.success) {
        ...
        await createVerificationRequestNotification(
          result.userId, // Get actual user ID from response
        ...
        setSubmitStatus({
          type: "success",
          message:
            "Your identification documents have been submitted successfully. We will review them within 24-48 hours.",
        });
        ...
        setSubmitStatus({
          type: "error",
          message: result.message || "Failed to submit verification documents",
        });
      }
    } catch (error) {
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="text-center space-y-2">
        ...
        <p className="text-gray-600">
          Submit your identification documents to verify your account
        </p>
      </div>
